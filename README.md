...
המערכת משתמשת ב-**2 קבצי JSON** במאגר:
...
- 💾 **Git היסטוריה מלאה** - רואים מתי ומה שונה
- 🔓 **גישה חופשית** - כל מי שיש לו את הקישור יכול להשתמש
...
- ✅ גם נשמר מוצפן ב-GitHub (settings.json) לנוחות
- ⚠️ ההצפנה היא פשוטה - מומלץ repository פרטי
- ✅ ניתן לבטל בכל עת ב-GitHub
- ✅ ניתן לשחזר מ-GitHub במכשיר חדש
